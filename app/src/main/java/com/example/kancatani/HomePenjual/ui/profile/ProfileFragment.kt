                ...
                if(p0.exists()){
                    p0.children.forEach{
                        ...
                        if(vl != null){
                            ...
                            SP.createSP(this@ProfileFragment.context!!, "username", vl.nama)
                            SP.createSP(this@ProfileFragment.context!!, "alamat", vl.alamat)
                            SP.createSP(this@ProfileFragment.context!!, "fotoprofil", vl.foto)
                            SP.createSP(this@ProfileFragment.context!!, "tgllahir", vl.tgllahir)
                            SP.createSP(this@ProfileFragment.context!!, "jk", vl.jk)
                            SP.createSP(this@ProfileFragment.context!!, "notelp", vl.notelp)
                            SP.createSP(this@ProfileFragment.context!!, "email", vl.email)
                            SP.createSP(this@ProfileFragment.context!!, "provinsi", vl.provinsi)
                            SP.createSP(this@ProfileFragment.context!!, "kota", vl.kota)
                            SP.createSP(this@ProfileFragment.context!!, "kecamatan", vl.kecamatan)
                        }
                    }
                }
            }
        ...
        dialog.setView(view)
            ...
            .setPositiveButton("Simpan", object: DialogInterface.OnClickListener{
                override fun onClick(p0: DialogInterface?, p1: Int) {
                    if(string == "username"){
                        SP.createSP(this@ProfileFragment.context!!, "username", edit.text.toString())
                        profil_username.text = edit.text.toString()
                    }else if(string == "telp"){
                        SP.createSP(this@ProfileFragment.context!!, "notelp", edit.text.toString())
                        profil_telp.text = edit.text.toString()
                    }else{
                        SP.createSP(this@ProfileFragment.context!!, "email", edit.text.toString())
        ...
        ref.putFile(isi)
            .addOnSuccessListener {
                ref.downloadUrl.addOnSuccessListener {
                    SP.createSP(this@ProfileFragment.context!!, "fotoprofil", it.toString())
                }
            }
