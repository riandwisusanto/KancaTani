package com.example.kancatani.Pembeli.ui.profile
...
class ProfilePembeliFragment : Fragment() {
                ...
                if(p0.exists()){
                    p0.children.forEach{
                        ...
                        if(vl != null){
                            ...
                            SP.createSP(this@ProfilePembeliFragment.context!!, "username", vl.nama)
                            SP.createSP(this@ProfilePembeliFragment.context!!, "alamat", vl.alamat)
                            SP.createSP(this@ProfilePembeliFragment.context!!, "fotoprofil", vl.foto)
                            SP.createSP(this@ProfilePembeliFragment.context!!, "tgllahir", vl.tgllahir)
                            SP.createSP(this@ProfilePembeliFragment.context!!, "jk", vl.jk)
                            SP.createSP(this@ProfilePembeliFragment.context!!, "notelp", vl.notelp)
                            SP.createSP(this@ProfilePembeliFragment.context!!, "email", vl.email)
                            SP.createSP(this@ProfilePembeliFragment.context!!, "provinsi", vl.provinsi)
                            SP.createSP(this@ProfilePembeliFragment.context!!, "kota", vl.kota)
                            SP.createSP(this@ProfilePembeliFragment.context!!, "kecamatan", vl.kecamatan)
                        }
                    }
                }
            }
        ...
        dialog.setView(view)
            ...
            .setPositiveButton("Simpan", object: DialogInterface.OnClickListener{
                override fun onClick(p0: DialogInterface?, p1: Int) {
                    if(string == "username"){
                        SP.createSP(this@ProfilePembeliFragment.context!!, "username", edit.text.toString())
                        profil_username.text = edit.text.toString()
                    }else if(string == "telp"){
                        SP.createSP(this@ProfilePembeliFragment.context!!, "notelp", edit.text.toString())
                        profil_telp.text = edit.text.toString()
                    }else{
                        SP.createSP(this@ProfilePembeliFragment.context!!, "email", edit.text.toString())
    ...
    private fun editalamat(){
        ...
        dialogalamat.setView(view)
            ...
            .setPositiveButton("Simpan", object: DialogInterface.OnClickListener{
                override fun onClick(p0: DialogInterface?, p1: Int) {
                    SP.createSP(this@ProfilePembeliFragment.context!!, "provinsi",Provinsi)
                    SP.createSP(this@ProfilePembeliFragment.context!!, "kota",Kota)
                    SP.createSP(this@ProfilePembeliFragment.context!!, "kecamatan",Kecamatan)
                    btn_save.setImageResource(R.drawable.ic_ceklis)
                    y = true
